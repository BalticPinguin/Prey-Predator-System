...
\captionof{figure}{Populationsentwicklung bei anderer Parameterwahl}
\end{minipage}
\begin{minipage}[b]{0.4\textwidth}
...
\captionof{figure}{die obige Populationsentwicklung im Phasenraum: Das besondere Verhalten wird deutlicher}
\end{minipage}
